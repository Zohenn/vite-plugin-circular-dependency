(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? module.exports = factory(require('chalk'), require('node:fs'), require('@rollup/pluginutils'), require('node:path')) :
    typeof define === 'function' && define.amd ? define(['chalk', 'node:fs', '@rollup/pluginutils', 'node:path'], factory) :
    (global = typeof globalThis !== 'undefined' ? globalThis : global || self, global.CircularDependency = factory(global.chalk, global.node_fs, global.pluginutils, global.node_path));
})(this, (function (chalk, node_fs, pluginutils, node_path) { 'use strict';
    ...
    const writeDataToInteractiveFile = (data, filePath) => {
        ...
        node_fs.writeFileSync(filePath, result, "utf-8");
    };
    ...
    function outputToFile(ctx, data) {
        node_fs.writeFileSync(ctx.outputFilePath, JSON.stringify(data, null, "\t"));
    }
    ...
    function createContext(options) {
        ...
        const rollupFilter = pluginutils.createFilter(include, exclude);
    ...
    function formatOptions(options) {
        ...
        if (outputFilePath) {
            outputFilePath = node_path.join(process.cwd(), outputFilePath);
        }
        return {
            include,
            exclude,
    ...
    function defaultFormatOutModulePath(path) {
        return node_path.relative(process.cwd(), path);
    }
